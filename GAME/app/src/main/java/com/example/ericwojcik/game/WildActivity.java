...
public class WildActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rvLayout = new LinearLayoutManager(WildActivity.this);
        rvLayout1 = new LinearLayoutManager(WildActivity.this);
        ...
        tv_title.setText(String.valueOf("WILD"));
        tv_rName1.setText(String.valueOf("Pick up"));
    ...
    public class MyAdapter extends RecyclerView.Adapter<MyViewHolder>{
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int i) {
            LayoutInflater li = LayoutInflater.from(WildActivity.this);
    ...
    private class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(LayoutInflater li, ViewGroup parent){
            ...
            buttonBox.setText(String.valueOf("PICK UP"));
    ...
    private class MyViewHolder2 extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder2(LayoutInflater li, ViewGroup parent){
            ...
            divider = (View) itemView.findViewById(R.id.divider2);
            buttonBox.setText((String.valueOf("DROP")));
            ...
            buttonBox1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v){
                    if(e instanceof SmellScope){
                        ...
                        //start activity//
                        Intent iIntent = new Intent(WildActivity.this, SmellScopeActivity.class);
                    ...
                    if(e instanceof SmellScope){
                        ...
                        Toast.makeText(WildActivity.this, "AN IMPROBABILITY HAS OCCURRED",
